...
python run_experiment.py emnist AGFL --pre_rounds 10 --n_rounds 20 --n_learners 2 --alpha 0.5 --local_step 5 --bz 128 --lr 0.1   --log_freq 2 --lr_scheduler multi_step --log_freq 2  --optimizer sgd --seed 1234 --verbose 1 --logs_root ./111 >>2.log
