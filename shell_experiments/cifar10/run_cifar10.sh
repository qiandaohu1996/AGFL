...
python run_experiment.py cifar10 FedAvg --n_learners 1 --n_rounds 200 --bz 128 --lr 0.01 \
 --lr_scheduler multi_step --log_freq 2  --optimizer sgd --seed 1234 --verbose 1
...
python run_experiment.py cifar10 FedAvg --n_learners 1 --locally_tune_clients --n_rounds 201 --bz 128 \
 --lr 0.001 --lr_scheduler multi_step --log_freq 2  --optimizer sgd --seed 1234 --verbose 1 
...
python run_experiment.py cifar10 FedProx --n_learners 1 --n_rounds 201 --bz 128 --lr 0.01 --mu 1.0\
 --lr_scheduler multi_step --log_freq 2  --optimizer prox_sgd --seed 1234 --verbose 1
...
python run_experiment.py cifar10 FedEM --n_learners 3 --n_rounds 201 --bz 128 --lr 0.03 \
 ...
 # run FedProx
echo "Run AGFL"
python run_experiment.py cifar10 AGFL --n_learners 1 --n_rounds 201 --bz 128 --lr 0.01 --mu 1.0\
 --lr_scheduler multi_step --log_freq 2 --optimizer sgd --seed 1234 --verbose 1  --logs_root logs/cifar10_validation/agfl_lr_0.003